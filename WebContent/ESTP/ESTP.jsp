...
<form id="frm" action="<%=request.getContextPath() %>/ESTP/ESTPcommentProc.jsp" method="post">
<div id="timeLine">
<div class="orderbyArea">
	...
	<div class="orderbyClicked" id="orderbyClicked"><a href="<%=request.getContextPath() %>/index.jsp?currentPage=ESTPOrderbyLikesSum">공감순</a></div>
...
%>
	<div class="reading">
		...
		<div class="likeArea">
			...
			<div class="likeBtn" >
				<a href="<%=request.getContextPath() %>/ESTP/ESTPLikesProc.jsp?likeBtn<%=count4++ %>=<%=t.getContentsid() %>" style="color:black;">공감하기</a>
			</div>		
