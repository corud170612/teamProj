...
<form id="frm" action="<%=request.getContextPath() %>/ENTP/ENTPcommentProc2.jsp" method="post">
<div id="timeLine">
<div class="orderbyArea">
	...
	<div class="orderbyClicked" id="orderbyClicked"><a href="<%=request.getContextPath() %>/index.jsp?currentPage=ENTPOrderbyLikesSum">공감순</div>
...
%>
	<div class="reading">
		...
		<div class="likeArea">
			...
			<div class="likeBtn" >
				<a href="<%=request.getContextPath() %>/ENTP/ENTPLikesProc2.jsp?likeBtn<%=count4++ %>=<%=t.getContentsid() %>" style="color:black;">공감하기</a>
			</div>		
